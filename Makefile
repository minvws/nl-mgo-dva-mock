ifdef DOCKER
  RUN_PREFIX := docker compose run --rm mock
else
  RUN_PREFIX :=
endif
...
test: ## Runs automated tests
	$(RUN_PREFIX) pytest --cov --cov-fail-under=100 --cov-branch
